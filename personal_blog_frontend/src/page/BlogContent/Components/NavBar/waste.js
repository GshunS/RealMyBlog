<ul className={classNames("nav-bar__second-category", { "expanded": expandedCategories.includes(firstCategoryName) })}>
    {expandedCategories.includes(firstCategoryName) && (

        Object.entries(secondCategoryName[firstCategoryName]).map(([secondCategoryName, secondHasChildren], secondIndex) => (
