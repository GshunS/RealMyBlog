...
const NavBarTempFolder = (props) => {
    ...
    const currentParentName = useSelector(state => state.blogContentNavbar.currentParentName)
    const parentCategoryName = props.parentCategoryName
    // console.log('NavBarTempFolder', parentCategoryName)
    // console.log('currentParentName is', currentParentName)
    return (
        <div className={classNames("nav-bar__category_div_temp", {'showFolder': parentCategoryName === currentParentName})}>
        {/* <div className={classNames("nav-bar__category_div_temp", {'showFolder': true})}> */}
            <div
